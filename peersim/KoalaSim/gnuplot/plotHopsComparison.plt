...
plot filename1 using 5 title "Renater" smooth csplines with lines lc rgb "forest-green" , \
	 ...
	 filename4 using 7 title "Koala A=0.25" smooth csplines with lines lc rgb "green" , \
	 filename5 using 7 title "Koala A=0.75" smooth csplines with lines lc rgb "brown" , \
	 filename6 using 7 title "Koala random" smooth csplines with lines lc rgb "orange"
pause mouse close