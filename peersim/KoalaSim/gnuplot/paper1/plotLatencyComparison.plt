...
gap = 0.03
size = 0.81
y1 = 0; y2 = 995; y3 = 1150; y4 = 3890
#y1 = 0.0; y2 = 50.0; y3 = 70.0; y4 = 100.0
...
plot filename6 using 2 title titler smooth csplines with lines lc rgb "forest-green" lw 1, \
	filename6 using 3 title titlec smooth csplines with lines lc rgb "red"  lw 1, \
	...
	filename3 using 4 title title3 smooth csplines with lines lc rgb "brown"  lw 1 ,\
 	filename4 using 4 title title4 smooth csplines with lines lc rgb "gray" lw 1 ,\
 	filename5 using 4 title title5 smooth csplines with lines lc rgb "violet" lw 1 
...
set label 'Latency (ms)' at screen 0.03, bm + 0.5 * (size + gap) offset 0,-strlen("Latency (ms)")/4.0 rotate by 90
...
plot filename1 using 4 title title1 smooth csplines with lines lc rgb "orange"  lw 1
