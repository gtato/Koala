...
plot filename1 using 2 title "Physical" smooth csplines with lines lc rgb "forest-green" ,\
	filename1  using 5 title "C=1" smooth csplines with lines lc rgb "red" , \
	filename2 using 5 title "C=2" smooth csplines with lines  lc rgb "brown", \
	filename3 using 5 title "C=4" smooth csplines with lines  lc rgb "blue"

#plot filename1 using 2 title "Physical" with lines lc rgb "forest-green" ,\
#	filename1  using 5 title "C=1" with lines lc rgb "red" , \
#	filename2 using 5 title "C=2" with lines  lc rgb "brown", \
#	filename3 using 5 title "C=4" with lines  lc rgb "blue"
