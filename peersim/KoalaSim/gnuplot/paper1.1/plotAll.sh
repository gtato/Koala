...
f2="tmp/1f2.mpl" 
f3="tmp/1f3.mpl" 
./group.py -f 'exp1/exp1resultsC1CH1A0.5.dat' -n $group > $f1 ;\
./group.py -f 'exp1/exp1resultsC2CH1A0.5.dat' -n $group > $f2 ;\
./group.py -f 'exp1/exp1resultsC4CH1A0.5.dat' -n $group > $f3 ;\
