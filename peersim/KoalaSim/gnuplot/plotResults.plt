...
plot "<(tail -n +3  ".datafile.")"  using 1 title "Koala" smooth csplines with lines lc rgb "blue" , \
	 "<(tail -n +3  ".datafile.")" using 2 title "Physical" smooth csplines with lines  lc rgb "forest-green", \
	 "<(tail -n +3  ".datafile.")" using 3 title "Chord" smooth csplines with lines  lc rgb "red"
