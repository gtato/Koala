...
plot koala0 using 4 title "Koala no collaboration" smooth csplines with lines lw 1.3 lc rgb "blue"  , \
	koala2  using 4 title "Koala col 2" smooth csplines with lines lw 1.3 dt 2 lc rgb "blue" , \
